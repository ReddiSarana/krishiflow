...
const UI_TEXT = {
  ...
  te: {
    title: 'రైతు సేకరణ స్లాట్ బుకింగ్ పోర్టల్',
    subtitle: 'ఏఐ ఆధారిత డైనమిక్ డ్రాప్-ఆఫ్ సమయం & డిజిటల్ కృషి-పాస్',
    farmerName: 'రైతు పూర్తి పేరు',
    phone: 'మొబైల్ నంబర్ (WhatsApp / SMS)',
    village: 'గ్రామం / మూల స్థానం',
    cropType: 'సేకరణ పంట రకం',
    quantity: 'పరిమాణం (క్వింటాళ్లలో)',
    vehicle: 'రవాణా వాహనం',
    distance: 'మండీ/గోదాము నుండి దూరం (కి.మీ.)',
    travelEst: 'అంచనా ప్రయాణ సమయం',
    preferredHour: 'ప్రాధాన్యత రాక సమయం',
    bookBtn: 'ఏఐ స్లాట్ & డిజిటల్ పాస్ రూపొందించండి',
    booking: 'గూగుల్ ఓఆర్-టూల్స్ ద్వారా స్లాట్ కేటాయింపు జరుగుతోంది...',
    passTitle: 'అధికారిక డిజిటల్ కృషి-పాస్ (టోకెన్)',
    bayAssigned: 'కేటాయించిన అన్‌లోడింగ్ బే',
    slotTime: 'మండీ రాక నిర్దిష్ట సమయం',
    departureAdvisory: 'స్మార్ట్ ప్రయాణ సలహా',
    departBy: 'ఖచ్చితమైన సమయానికి చేరడానికి బయలుదేరాల్సిన సమయం',
    spoilageProtection: 'నాణ్యత & నష్టం నివారణ రేటింగ్',
    stageTracker: 'ప్రత్యక్ష సేకరణ ప్రక్రియ ట్రాకర్',
    payoutEst: 'అంచనా వేసిన ప్రత్యక్ష నగదు బదిలీ (DBT మొత్తం)',
    offlineReady: 'ఆఫ్‌లైన్ గేట్ ఎంట్రీ కోసం భద్రపరచబడింది',
    stages: ['పొలం వద్ద షెడ్యూల్', 'గేట్ రాక', 'వే-బ్రిడ్జ్ (స్థూల బరువు)', 'నాణ్యత ల్యాబ్ పరీక్ష', 'బే అన్‌లోడింగ్', 'డీబీటీ చెల్లింపు']
  },
  mr: {
